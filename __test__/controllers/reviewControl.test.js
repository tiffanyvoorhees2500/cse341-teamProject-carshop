...
describe('Review Controller', () => {
  ...
  describe('addReview', () => {
    it('should add a new review and return status 201', async () => {
      const mockCar = {
        _id: {
          $oid: '670fee462c904f621ec06b12',
        },
      };
      const mockReview = {
        _id: '670fee462c904f621ec06b12',
        user: '670febee2c904f621ec06b0b', // Keep as ObjectId
        car: '670fee462c904f621ec06b12', // Keep as ObjectId
        rating: 5,
        comment: 'Great car!',
      };
  ...
  describe('editReviewById', () => {
    it('should edit a review and return status 202', async () => {
      const mockReview = {
        _id: '670fee462c904f621ec06b12',
        user: '670febee2c904f621ec06b0b',
        car: '670fee462c904f621ec06b12',
        rating: 5,
        comment: 'Great car!',
      };
     
      const req = {
        params: { reviewId: '670fee462c904f621ec06b12' },
